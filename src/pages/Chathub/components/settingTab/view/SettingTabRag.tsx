...
import EditButtonHead from '../../edit/view/EditButtonHead';
import EditToggle from '@/shared/components/toggle/view/EditToggle';
import EditCounter from '../../edit/view/EditCounter';
import EditCheckbox from '../../edit/view/EditCheckbox';
import { RAG_EMBEDDING_TYPE } from '@/shared/lib/data';
...
import ModalFunctionsItem from '@/shared/components/modal/view/ModalFunctionsItem';
  ...
  const getFunctions = async () => {
    ...
    if (response && response.data) {
      ...
      if (functionsData && functionsData.length > 0) {
        const tempData = functionsData.map((item: any) => {
          return {
            id: item.id,
            value: item.id,
            labelText: item.name,
        ...
        const checkedFunctions = tempData.filter((item: any) => item.isChecked);
