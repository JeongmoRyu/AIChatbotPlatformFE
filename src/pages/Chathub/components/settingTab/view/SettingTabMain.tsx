...
import ico_warning from '@/shared/assets/images/icons/ico_warning.png';
...
import useGetEngineData from '@/shared/hooks/useGetEngineData';
...
interface Props {
  ...
  handleChange: (type: any, key: any, value: any, parameters?: IEngineParameter) => void;
...
const SettingTab = ({ data, handleChange, handleChangeImage, valueCheck }: Props) => {
  ...
  const allEngineApi = useGetEngineData();
  ...
  type AccordionKeys = 'llmCommonBox' | 'retrievalBox' | 'ragBox' | 'normalBox';
    ...
    <>
      ...
      <div className="accordion_box open">
        <div className="accordion_content">
          {['admin', 'superAdmin'].includes(userAuthority) && data.hidden_yn !== undefined && (
            <EditToggle
              title="챗봇 숨김"
              id="hidden_yn"
      ...
      <div id="ragBox" className={`accordion_box ${openAccordion.ragBox ? 'open' : ''}`}>
        ...
        <div className="accordion_content">
          <SettingTabRag
            ...
            llmSelectList={llmEngineList}
            llmFunctionSelectList={llmFnCallEngineApi}
